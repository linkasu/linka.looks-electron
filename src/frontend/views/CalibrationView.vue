    ...
    <div class="content">
        <v-container grid-list-xs>
            <v-card>
                ...
                <v-card-text>
                    Tobii не подключён или ещё не готов, поэтому используется резервная настройка масштаба. <br>
                    Используйте переключатель ниже и проверьте выбор по кнопкам с мишенями. Выбор и реакция должны совпадать.
                </v-card-text>
                <v-card-text>
